    ...
    testList
        ...
        [ testList
              ...
              [ testCase "null"
                ...
                testCase "map keys sorted by length then lex"
                <| fun () ->
                    // Keys: "b" (1 char), "aa" (2 chars) -> sorted: "b" first (shorter)
                    let value =
                        AtpValue.Object (Map.ofList [ ("aa", AtpValue.Integer 2L); ("b", AtpValue.Integer 1L) ])
                    ...
                    Expect.equal
                        bytes
                        [| 0xA2uy; 0x61uy; 0x62uy; 0x01uy; 0x62uy; 0x61uy; 0x61uy; 0x02uy |]
                        "keys sorted by length"
          ...
          testList
              ...
              [ testCase "null"
                ...
                <| fun () ->
                    ...
                    let bytes =
                        Array.concat [| [| 0xFBuy |]; BitConverter.GetBytes (1.5) |> Array.rev |]
          ...
          testList
              "roundtrip"
              [ testCase "encode then decode primitives"
                <| fun () ->
                    let values =
                        [ AtpValue.Null
                          AtpValue.Bool true
                ...
                testCase "encode then decode nested structure"
                <| fun () ->
                    let value =
                        AtpValue.Object (
                            Map.ofList
                ...
                testCase "encode then decode CID link"
                <| fun () ->
