...
let lexTypeToFSharpTypeTests =
    testList
        ...
        [ testCase "Boolean maps to bool"
          ...
          testCase "Integer maps to int64"
          <| fun () ->
          ...
          testCase "String maps to string"
          <| fun () ->
          ...
          testCase "String with DID format maps to Did"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
          ...
          testCase "String with datetime format maps to AtDateTime"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
          ...
          testCase "Array of strings maps to string list"
          <| fun () ->
          ...
          testCase "Array of integers maps to int64 list"
          <| fun () ->
          ...
          testCase "Array of refs maps to qualified type list"
          <| fun () ->
              let arr =
                  emptyArrayOf (
                      Ref
          ...
          testCase "Ref in same namespace uses Module.TypeName"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
          ...
          testCase "Ref to different namespace uses Namespace.Module.TypeName"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
              ...
              Expect.equal
                  ...
                  "Ref to different namespace should use Namespace.Module.TypeName"

          testCase "Ref with main def uses module name as type name"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
          ...
          testCase "Union maps to JsonElement"
          <| fun () ->
              let result =
                  lexTypeToFSharpType
                      "AppBskyFeed"
                      (Union
                          { Description = None
                            Refs = [ "app.bsky.feed.defs#feedViewPost" ]
                            Closed = false })

              Expect.equal result "JsonElement" "Union should map to JsonElement"

          testCase "Object maps to JsonElement"
          <| fun () ->
              let obj =
                  Object
                      { Description = None
          ...
          testCase "Params maps to JsonElement"
          <| fun () ->
              let p =
                  Params
                      { Description = None
...
let collectNamespaceDepsTests =
    testList
        "collectNamespaceDeps"
        [ testCase "Ref to same namespace returns empty set"
          <| fun () ->
              let result =
                  collectNamespaceDeps
                      "AppBskyFeed"
          ...
          testCase "Ref to different namespace returns that namespace"
          <| fun () ->
              let result =
                  collectNamespaceDeps
                      "AppBskyFeed"
          ...
          testCase "Array of cross-namespace ref returns that namespace"
          <| fun () ->
              let arr =
                  emptyArrayOf (
                      Ref
              ...
              Expect.equal
                  result
                  (Set.singleton "ComAtprotoRepo")
                  "Array of cross-ns ref should return target namespace"

          testCase "Array of same-namespace ref returns empty set"
          <| fun () ->
              let arr =
                  emptyArrayOf (
                      Ref
          ...
          testCase "Union with mixed refs returns cross-namespace deps"
          <| fun () ->
              let u =
                  Union
                      { Description = None
          ...
          testCase "Union with all same-namespace refs returns empty set"
          <| fun () ->
              let u =
                  Union
                      { Description = None
                        Refs = [ "app.bsky.feed.defs#feedViewPost"; "app.bsky.feed.post" ]
                        Closed = false }

              let result = collectNamespaceDeps "AppBskyFeed" u
              Expect.equal result Set.empty "Union with all same-ns refs should return empty set"

          testCase "Object with cross-namespace property returns that namespace"
          <| fun () ->
              let obj =
                  Object
                      { Description = None
              ...
              Expect.equal
                  result
                  (Set.singleton "ComAtprotoRepo")
                  "Object with cross-ns ref should return that namespace"

          testCase "Object with multiple cross-namespace properties returns all"
          <| fun () ->
              let obj =
                  Object
                      { Description = None
          ...
          testCase "Primitive types return empty set"
          <| fun () ->
              let types =
          ...
          testCase "Nested array of cross-namespace ref"
          <| fun () ->
