    ...
    testList
        ...
        [ testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<Did> "\"not-a-did\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                <| fun () -> expectInvalid<Handle> "\"not a handle!\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                <| fun () ->
                    ...
                    Expect.equal
                        (AtUri.value result)
                        "at://did:plc:z72i7hdynmk6r22z27h6tvur/app.bsky.feed.post/3k2la3b"
                        "AtUri roundtrip"

                testCase "rejects invalid"
                <| fun () -> expectInvalid<AtUri> "\"https://example.com\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<Cid> "\"ab\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<Nsid> "\"not-an-nsid\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<Tid> "\"tooshort\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<RecordKey> "\".\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid"
                <| fun () -> expectInvalid<AtDateTime> "\"not-a-datetime\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid" <| fun () -> expectInvalid<Language> "\"123\"" ]
          ...
          testList
              ...
              [ testCase "roundtrip"
                ...
                testCase "rejects invalid"
                <| fun () -> expectInvalid<Uri> "\"not a uri with spaces\"" ]

          testCase "serializes to JSON string"
          <| fun () ->
              let did =
                  Did.parse "did:plc:z72i7hdynmk6r22z27h6tvur" |> Result.defaultWith failwith
