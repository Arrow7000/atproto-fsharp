        ...
        [ testList
              ...
              [ for item in validDoc.RootElement.EnumerateArray () do
                    ...
                    testCase name (fun () ->
                        ...
                        Expect.isOk result (sprintf "Expected valid lexicon '%s' to parse, got: %A" name result)) ]
          testList
              "invalid lexicons"
              [ for item in invalidDoc.RootElement.EnumerateArray () do
                    ...
                    testCase name (fun () ->
                        let result = LexiconParser.parseElement lexicon
                        Expect.isError result (sprintf "Expected invalid lexicon '%s' to fail parsing" name)) ] ]
