...
type DidConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Did.value v)
...
type HandleConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Handle.value v)
...
type AtUriConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (AtUri.value v)
...
type CidConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Cid.value v)
...
type NsidConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Nsid.value v)
...
type TidConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Tid.value v)
...
type RecordKeyConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (RecordKey.value v)
...
type AtDateTimeConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (AtDateTime.value v)
...
type LanguageConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Language.value v)
...
type SyntaxUriConverter () =
    ...
    override _.Write (writer, v, _) = writer.WriteStringValue (Uri.value v)
